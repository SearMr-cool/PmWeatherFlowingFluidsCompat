...
public class Config {
    ...
    static  {
        ...
        water_drains_rain = BUILDER.comment("Should rain be drained while it is raining? If enabled it will make flooding very difficult plus lag may occur so it is recommended to leave this off").define("waterdrainsrain",false);
